...
const stacks = [
  ...
  },
  {
    ...
    description: 'Real-time visibility, compliance tracking, and operational control for high-value mobile assets. Handover and handback workflows, maintenance scheduling, uptime dashboards, and contract revenue management. Know where everything is, who has it, and what state it is in.',
    badge: '/stacks/stack_track.png',
    color: '#6080A9',
    inProduction: 'In development with early adopters in equipment hire',
